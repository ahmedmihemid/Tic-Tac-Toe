...
namespace Tic_Tac_Toe
{
    public partial class Form3 : Form
    {
        ...
        public char[,] Array5X5 = new char[5, 5];
        ...
        private bool CheckRow(char PlayType, int RowIndex, int columnIndex)
        {
            ...
            for (int i = columnIndex + 1; i < Array5X5.GetLength(1); i++)
            {
                if (Array5X5[RowIndex, i] != PlayType)
                    break;
                num++;
            }
        ...
        private bool CheckColumn(char PlayType, int RowIndex, int columnIndex)
        {
            ...
            for (int i = RowIndex + 1; i < Array5X5.GetLength(0); i++)
            {
                if (Array5X5[i, columnIndex] != PlayType)
                    break;
                num++;
            }
        ...
        private bool CheckPolar(char PlayType, int RowIndex, int columnIndex)
        {
            ...
            for (int i = RowIndex + 1, j = columnIndex + 1; i < Array5X5.GetLength(0) && j < Array5X5.GetLength(1); i++, j++)
            {
                if (Array5X5[i, j] != PlayType)
                    break;
                num++;
            }
        ...
        private bool CheckReversePolar(char PlayType, int RowIndex, int columnIndex)
        {
            ...
            for (int i = RowIndex + 1, j = columnIndex - 1; i < Array5X5.GetLength(0) && j >= 0; i++, j--)
            {
                if (Array5X5[i, j] != PlayType)
                    break;
                num++;
            ...
            for (int i = RowIndex - 1, j = columnIndex + 1; i >= 0 && j < Array5X5.GetLength(1); i--, j++)
            {
                if (Array5X5[i, j] != PlayType)
                    break;
                num++;
